export const translations = {
  vi: {
    ...
    student: {
      title: "Công cụ",
      login: "Đăng nhập",
      loginSubtitle: "Truy cập hệ thống sinh viên",
      ...
      noAccount: "Chưa có tài khoản? Liên hệ phòng Công tác sinh viên",
      tools: {
        studentPortal: "Cổng thông tin sinh viên",
        studentPortalDesc: "Truy cập thông tin cá nhân, kết quả học tập",
        elearning: "E-learning",
        elearningDesc: "Hệ thống học tập trực tuyến",
        courseRegistration: "Đăng ký học phần",
        courseRegistrationDesc: "Đăng ký môn học và xem thời khóa biểu",
        timetable: "Thời khóa biểu",
        timetableDesc: "Xem lịch học và lịch thi",
        studentConfirmation: "Xác nhận sinh viên tại trường",
        studentConfirmationDesc: "Xác nhận thông tin sinh viên",
        supportPortal: "Cổng thông tin hỗ trợ",
        supportPortalDesc: "Hỗ trợ kỹ thuật và tư vấn",
        libraryPortal: "Cổng Thư viện",
        libraryPortalDesc: "Truy cập tài liệu và sách tham khảo",
        studentHandbook: "Cẩm nang sinh viên",
        studentHandbookDesc: "Hướng dẫn và quy định cho sinh viên",
    ...
    contact: {
      ...
      admissionConsultation: "Tư vấn tuyển sinh",
      educationInfo: "Thông tin đào tạo",
      researchCooperation: "Hợp tác nghiên cứu",
      businessCooperation: "Liên kết doanh nghiệp",
      other: "Khác",
  ...
  en: {
    ...
    student: {
      title: "Tools",
      login: "Login",
      loginSubtitle: "Access student system",
      ...
      noAccount: "No account? Contact Student Affairs Office",
      tools: {
        studentPortal: "Student Information Portal",
        studentPortalDesc: "Access personal information and academic results",
        elearning: "E-learning",
        elearningDesc: "Online learning system",
        courseRegistration: "Course Registration",
        courseRegistrationDesc: "Register courses and view schedules",
        timetable: "Timetable",
        timetableDesc: "View class and exam schedules",
        studentConfirmation: "Student Confirmation at School",
        studentConfirmationDesc: "Confirm student information",
        supportPortal: "Support Information Portal",
        supportPortalDesc: "Technical support and consultation",
        libraryPortal: "Library Portal",
        libraryPortalDesc: "Access documents and reference books",
        studentHandbook: "Student Handbook",
        studentHandbookDesc: "Guidelines and regulations for students",
    ...
    contact: {
      ...
      admissionConsultation: "Admission Consultation",
      educationInfo: "Education Information",
      researchCooperation: "Research Cooperation",
